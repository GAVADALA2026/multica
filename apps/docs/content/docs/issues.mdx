...
Categories keep filters and lifecycle reasoning simple. Boards, lists, and sorting work from the individual status, and the concrete statuses preserve the more specific workflow behavior agents and automations rely on.
